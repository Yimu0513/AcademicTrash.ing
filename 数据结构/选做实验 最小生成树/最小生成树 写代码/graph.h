...
public:
    ...
    void PutVex(int i, T value);            //修改数据
    void PrintVex(); ;                         //取顶点               
    ...
    void SpaningTree(int v)  ;              //基于深度遍历的深度优先生成树
    void BFSTree(int v) ;                  //基于广度遍历的深度优先生成树
	void Prim(int v)  ;                     //最小生成树Prim 算法  注意是无向图                         
    void Kruskal();                        //最小生成树 Kruskal 算法  注意是无向图
